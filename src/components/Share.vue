    ...
    share() {
      ShareAPI.share(this.toShare).then((r) => {
        ...
        this.$buefy.dialog.alert({
          ...
          message: `${this.$t('share.PICK_LIST_SAVED_MSG')}<br /><b><a href="https://cardanocataly.st/voter-tool/#/f6/shared/${r.data.pick_list.uuid}" target="_blank">https://cardanocataly.st/voter-tool/#/f6/shared/${r.data.pick_list.uuid}</a></b>`,
          confirmText: 'OK'
        })
      })
    }
